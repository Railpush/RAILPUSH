...
func setupRoutes(r *mux.Router, cfg *config.Config, worker *services.Worker, wsH *handlers.WebSocketHandler) {
	...
	authed.HandleFunc("/services/{id}/shell", svcH.CreateShellSession).Methods("POST")
	authed.HandleFunc("/shell/{sessionId}/exec", svcH.ExecShellSession).Methods("POST")
	authed.HandleFunc("/shell/{sessionId}", svcH.CloseShellSession).Methods("DELETE")
	...
	authed.HandleFunc("/services/{id}/fs", svcH.ListServiceFilesystem).Methods("GET")
	authed.HandleFunc("/services/{id}/fs/read", svcH.ReadServiceFilesystemFile).Methods("GET")
	authed.HandleFunc("/services/{id}/fs/search", svcH.SearchServiceFilesystem).Methods("GET")
	...
	authed.HandleFunc("/databases/{id}/rotate-password", dbH.RotateDatabasePassword).Methods("POST")
	authed.HandleFunc("/databases/{id}/query", dbH.QueryDatabase).Methods("POST")
	authed.HandleFunc("/databases/{id}/retention", dbH.GetRetention).Methods("GET")
	authed.HandleFunc("/databases/{id}/retention", dbH.UpdateRetention).Methods("PUT")
	authed.HandleFunc("/databases/{id}/recovery-window", dbH.GetRecoveryWindow).Methods("GET")
	...
	authed.HandleFunc("/workspaces/{id}/notifications", workH.GetNotificationChannels).Methods("GET")
	authed.HandleFunc("/workspaces/{id}/notifications", workH.UpdateNotificationChannels).Methods("PUT")
	authed.HandleFunc("/workspaces/{id}/retention", workH.GetRetention).Methods("GET")
	authed.HandleFunc("/workspaces/{id}/retention", workH.UpdateRetention).Methods("PUT")
	authed.HandleFunc("/workspaces/{id}/compliance", workH.GetCompliancePolicy).Methods("GET")
	authed.HandleFunc("/workspaces/{id}/compliance", workH.UpdateCompliancePolicy).Methods("PUT")
	authed.HandleFunc("/workspaces/{id}/compliance/report", workH.GetComplianceReport).Methods("GET")
