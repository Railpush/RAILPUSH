...
RUN printf 'server {\n  listen %d;\n  server_name _;\n  root /usr/share/nginx/html;\n  index index.html;\n\n  # CDN-friendly: gzip all compressible types\n  gzip on;\n  gzip_vary on;\n  gzip_proxied any;\n  gzip_min_length 256;\n  gzip_types text/plain text/css application/json application/javascript text/xml application/xml application/xml+rss text/javascript image/svg+xml;\n\n  location = /healthz {\n    add_header Content-Type text/plain;\n    return 200 ok;\n  }\n\n  # Hashed assets (JS/CSS bundles) — immutable, cache 1 year\n  location ~* \\\\.[0-9a-f]{8,}\\\\.(js|css|woff2?|ttf|eot|svg|png|jpe?g|gif|ico|webp|avif|map)$ {\n    expires 365d;\n    add_header Cache-Control \"public, max-age=31536000, immutable\";\n    try_files $uri =404;\n  }\n\n  # Other static assets without hash — cache 1 hour, revalidate\n  location ~* \\\\.(js|css|woff2?|ttf|eot|svg|png|jpe?g|gif|ico|webp|avif)$ {\n    expires 1h;\n    add_header Cache-Control \"public, max-age=3600, must-revalidate\";\n    try_files $uri =404;\n  }\n\n  # HTML pages — no cache (always serve latest)\n  location / {\n    add_header Cache-Control \"no-cache, no-store, must-revalidate\";\n    try_files $uri $uri/ /index.html;\n  }\n}\n' > /etc/nginx/conf.d/default.conf
ENV HOME=/tmp
RUN addgroup -g 65532 -S nonroot && adduser -u 65532 -S -G nonroot -h /tmp nonroot
USER 65532
EXPOSE %d
