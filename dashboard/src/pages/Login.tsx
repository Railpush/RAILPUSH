      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 relative bg-surface-primary">
        ...
        <div className="w-full max-w-[400px] relative z-10">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 h-11 rounded-xl bg-[#238636] hover:bg-[#2ea043] text-white text-sm font-medium transition-all duration-200 mb-6"
          >
